...
<div id="menu_vertical">
    ...
    <div class="titre">
        <a href=""><img id="icone_moins" src ="img/icones/soustraction.png" alt="icone" style="border:none" width="25px" height ="25px" /></a>
    </div>
   <div class="titre">
        
        <a href=""><img id="icone_plus" src ="img/icones/plus.png" alt="icone" style="border:none" width="25px" height ="25px" /></a>
    </div> 
            
    <div class="titre">
        <a href=""><img id="logo_jump" src ="img/icones/logo_jump.png" alt="icone" style="border:none" width="35px" height ="35px"/></a>
    </div>
    <div class="titre">    
        <a href=""><img id="icone_projets" src ="img/icones/nos_projets.png" alt="icone" style="border:none"width="35px" height ="35px"/></a>
    </div>
    <div class="titre">
        <a href=""><img id="icone_equipe" src ="img/icones/notre_equipe.png" alt="icone" style="border:none" width="35px" height ="35px"/></a>
    </div>
</div>
<div id="texte_abord">
    <h3 id="plus">Plus</h3>
    <h3 id="emploi">Marché de l'emploi</h3> 
    <h3 id="projets">projets réalisés</h3>
    <h3 id="equipe">notre équipe</h3>
</div>
                ...
                <div class="container  margin-shifted-vertical">
                  ...
                  <form id="form_mail" class="form-horizontal" role="form" accept-charset="UTF-8">
                    ...
                    <div class="input-group full-width">
                      ...
                      <div class="col-sm-10">
                        <textarea id="message" class="form-control" rows="4" name="message" data-toggle="tooltip" data-placement="right" placeholder="Je réfléchis à un projet de SIG web depuis longtemps. Je voudrais le confier à un étudiant en géomatique. J'ai alors pensé à Vertigéo. J'aimerais rencontrer votre équipe pour en discuter. Quand êtes-vous disponible ?"></textarea>
                      </div>
                    </div>
